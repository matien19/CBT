                                  ...
                                  <td>
                                    <center>
                                      <button class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-editdata" data-kd_jurusan="<?= $kd_jurusan; ?>"
                                        data-jurusan="<?= $data['nama']; ?>">
                                        <i class="fas fa-edit"></i>
                                        Edit
                                      </button>

                                      <a href="delete.php?id=<?= $kd_jurusan; ?>" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Anda akan menghapus data Jurusan [ <?= $data['nama']; ?> ] ?')">
