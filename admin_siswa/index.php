          ...
          <div class="col-lg-12">
            <div class="card">
               ...
               <font color="ffffff">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-tambahsiswa" style="background-color:#86090f">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-importdata">
                 ...
                 <a href="reset.php" class="btn btn-danger" onclick="return confirm('Anda akan menghapus seluruh data Siswa?')">
                ...
                <?php 
                 ...
                 { ?>
                 <a href="nonaktifall.php" class="btn btn-warning" onclick="return confirm('Anda akan Me-nonaktifkan seluruh Siswa?')">
                  <i class="nav-icon fas fa-sync"></i> Non-Aktikan Semua
                </a>
                 <?php } else {
                  ?>
                  <a href="aktifall.php" class="btn btn-primary" onclick="return confirm('Anda akan Mengaktifkan seluruh Siswa?')">
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  if ($stt=='T')
                                    {
                                     ?>
                                     <a href="aktifkan.php?nis=<?= $data['nis']; ?>" class="btn btn-success btn-sm" onclick="return confirm('Anda akan mengakitfkan siswa [ <?=$data['nis'] .' - '. $data['nama']; ?> ]?')">
                                <i class="fas fa-sync"></i>
                                   Aktifkan
                                    ...
                                    {
                                      ?>
                                   <a href="nonaktif.php?nis=<?= $data['nis']; ?>" class="btn btn-warning btn-sm" onclick="return confirm('Anda akan mengakitfkan siswa [ <?=$data['nis'] .' - '. $data['nama']; ?> ]?')">
                                <i class="fas fa-sync"></i>
                                   Non-Aktifkan
                              </a> 
                                     <?php 
                                ...
                                <button class="btn btn-primary btn-sm"  data-toggle="modal" data-target="#modal-editsiswa" data-nis="<?=$data['nis'];?>" data-nama="<?=$data['nama'];?>" data-kelas="<?=$data['kelas'];?>"  data-jurusan="<?=$data['kode_jurusan'];?>" data-stat="<?=$stt?>">
                                  <i class="fas fa-edit"></i>
                                   Edit 
                                </button> 
                                   
                                <a href="delete.php?nis=<?=$data['nis'];?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda akan menghapus data Siswa [ <?=$data['nis'] .' - '. $data['nama']; ?> ] ?')">
