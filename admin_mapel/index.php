                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="reset.php" class="btn btn-danger"
                          onclick="return confirm('Anda akan menghapus seluruh data mata pelajaran?')">
                                  ...
                                  <td>
                                    <center>
                                      <button class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-editdata" data-id="<?= $id; ?>"
                                        data-mapel="<?= $data['nama']; ?>">
                                        <i class="fas fa-edit"></i>
                                        Edit
                                      </button>

                                      <a href="delete.php?id=<?= $id; ?>" class="btn btn-danger btn-sm"
                                        onclick="return confirm('Anda akan menghapus data Mata Pelajaran [ <?= $data['nama']; ?> ] ?')">
